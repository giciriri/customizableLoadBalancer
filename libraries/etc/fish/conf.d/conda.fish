set -gx CONDA_EXE (cygpath "D:/customizableLoadBalancer/libraries\Scripts\conda.exe")
set _CONDA_ROOT (cygpath "D:/customizableLoadBalancer/libraries")
set _CONDA_EXE (cygpath "D:/customizableLoadBalancer/libraries\Scripts\conda.exe")
set -gx CONDA_PYTHON_EXE (cygpath "D:/customizableLoadBalancer/libraries\python.exe")
